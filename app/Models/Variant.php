...
class Variant extends Model
{
    ...
    /**
     * Границы срока изготовления — общие для валидации запроса и нормализации
     * в VariantService, чтобы правило жило в одном месте.
     */
    public const PRODUCTION_TIME_MIN_DAYS = 1;

    public const PRODUCTION_TIME_MAX_DAYS = 365;
