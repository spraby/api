...
Route::prefix('admin')->name('admin.')->middleware('inertia')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::put('/onboarding', [App\Http\Controllers\Admin\AdminOnboardingController::class, 'update'])
        ...
        Route::put('/orders/{order}/shippings', [App\Http\Controllers\Admin\OrderController::class, 'updateShippings'])->name('orders.shippings.update');
