                        ...
                        <div className="grid grid-cols-12 gap-5">
                            ...
                            <div className="col-span-7 space-y-4">
                                ...
                                {variants.map((variant, index) => (
                                    <div key={getVariantKey(variant, index)}
                                        ...
                                        <div className="grid grid-cols-12 gap-5">
                                            <div className="col-span-3 flex flex-col gap-2">
                                                {variant.image_url ? (
                                                    ...
                                                    <div
                                                        className="flex size-20 items-center justify-center rounded-md border bg-muted">
                                            ...
                                            <div className="col-span-9 grid gap-4 grid-cols-12">
                                                ...
                                                <div className="space-y-2 col-span-12 grid grid-cols-12 gap-5">
                                                    ...
                                                    <div className="space-y-2 col-span-6">
                                                        <Label className="flex items-center gap-1"
                                                               htmlFor={`variant-final-price-${index}`}>
                                                        ...
                                                        <Input
                                                            ...
                                                            onChange={(e) => {
                                                                updateVariant(index, 'final_price', e.target.value);
                                                            }}
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                {Boolean(product?.category?.options?.length) && !!product?.category?.options && (
