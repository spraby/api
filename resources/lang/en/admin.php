...
return [
    ...
    'emails' => [
        'title' => 'Emails',
        'description' => 'Outgoing email queue and delivery history',
    ],
    ...
    'emails_table' => [
        ...
        'templates' => [
            'order_created_user' => 'Order created (customer)',
            'order_created_admin' => 'New order (admin)',
            'brand_request_created_user' => 'Brand request created (customer)',
            'brand_request_created_admin' => 'New brand request (admin)',
            'brand_request_approved_user' => 'Brand request approved (customer)',
            'brand_request_rejected_user' => 'Brand request rejected (customer)',
            'category_request_created_user' => 'Category request created (customer)',
            'category_request_created_admin' => 'New category request (admin)',
            'category_request_reviewed_user' => 'Category request reviewed (customer)',
        ],
        'actions' => [
            'open_menu' => 'Open menu',
            'view' => 'Details',
        ...
        'confirm' => [
            'cancel' => 'Cancel sending of this email?',
            'resend' => 'Send another copy of this email to :email?',
            'delete' => 'Delete this email? This cannot be undone.',
        ],
        'bulk' => [
            'selected' => 'selected',
            'clear_selection' => 'Clear selection',
        ...
        'filters' => [
            'search_placeholder' => 'Search by email or subject...',
            'all_statuses' => 'All statuses',
    ...
    'email_show' => [
        ...
        'fields' => [
            ...
            'recipient' => 'Recipient',
            'sender' => 'Sender',
            'sender_default' => 'Default (from config)',
            'reply_to' => 'Reply-To',
            'locale' => 'Locale',
            'status' => 'Status',
            'attempts' => 'Attempts',
            ...
            'source' => 'Source',
            'resend' => 'Resend',
            'resend_open' => 'Open in Resend',
        ],
        'actions' => [
            'send_copy' => 'Send copy to me',
            'resend' => 'Resend',
            'delete' => 'Delete',
        ],
        'confirm' => [
        ...
        'preview_unavailable' => 'Template is missing or could not be rendered.',
    ],
    ...
    'brands_edit' => [
        ...
        'page' => [
            ...
            'switch' => 'Page is published',
            'hint_published' => 'The page is open to customers.',
            'hint_blocked' => 'Visibility is off: the page returns 404.',
            'published_at' => 'Published',
            'open' => 'Open page',
            'published' => 'The brand page is published.',
            'blocked' => 'The brand page is hidden.',
            'domain_required' => 'Set the domain first: without it the page has no address.',
        ],
        'domain' => [
            'title' => 'Page domain',
    ...
    'moderation' => [
        ...
        'show' => [
            ...
            'reason' => 'Reason',
            'no_details' => 'Details for this request type are not configured yet.',
            'empty_value' => 'Not filled in',
            'actions' => [
                'title' => 'Decision',
                'description' => 'Approving publishes the brand page, rejecting returns it to draft.',
                'reason' => 'Comment',
                'reason_placeholder' => 'What the brand should fix, or why the request is approved',
                'reason_hint' => 'A comment is required when rejecting — the brand sees it in settings.',
                'reason_required' => 'Please provide a rejection reason.',
                'approve' => 'Approve',
                'reject' => 'Reject',
            ],
            'messages' => [
                'approved' => 'Request approved, the brand page is published.',
                'rejected' => 'Request rejected.',
            ],
            'errors' => [
            ...
            'brand' => [
                ...
                'domain_locked' => 'The domain is already assigned. It can be changed on the brand page.',
                'page_status' => 'Page status',
                'products' => 'Products',
                'categories' => 'Categories',
                'about' => 'About',
                'refund_policy' => 'Refund policy',
                'owner' => 'Owner and contacts',
                'owner_name' => 'Name',
                'owner_email' => 'Email',
                'owner_phone' => 'Phone',
                'no_owner' => 'No user is linked to this brand.',
            ],
        ],
        'filters' => [
            'all_statuses' => 'All statuses',
    ...
    'my_page' => [
        ...
        'errors' => [
            'not_found' => 'Brand not found.',
            'already_published' => 'The brand page is already published.',
            'already_requested' => 'A request has already been submitted and is awaiting review.',
        ],
    ],
];
