...
return [
    ...
    'dashboard' => [
        ...
        'kpi' => [
            ...
            'category_preview_3' => 'Cookies',
            'category_preview_4' => 'Tea',
            'conversion_view_to_atc' => 'View → Cart',
            'conversion_view_to_order' => 'View → Order',
            'conversion_view_to_paid' => 'View → Payment',
            'conversion_order_to_paid' => 'Order → Payment',
        ],
        'charts' => [
            'toggle_sales' => 'Sales',
            'toggle_interest' => 'Interest',
            'sales_title' => 'Sales by day',
        ...
        'tables' => [
            ...
            'top_description' => 'Revenue leaders for the period',
            'gap_title' => 'Top conversion',
            'gap_description' => 'Products with the highest conversion rate',
            'toggle_top' => 'Top sales',
            'toggle_gap' => 'Top conversion',
            'headers' => [
                'product' => 'Product',
                'revenue' => 'Revenue',
                'orders' => 'Orders',
                ...
                'gap_views' => 'Views',
                'gap_orders' => 'Orders',
                'gap_conversion' => 'Conversion',
                'view_to_cart' => 'View → Cart',
                'view_to_order' => 'View → Order',
        ...
        'orders_widget' => [
            ...
            'unpaid_total' => 'Unpaid',
            'unpaid_count' => 'Orders: :count',
            'partial_paid_total' => 'Partially',
            'partial_paid_count' => 'Orders: :count',
            'paid_total' => 'Paid',
            'paid_count' => 'Orders: :count',
            'no_statuses' => 'No orders for selected period',
            'cta' => 'Go to orders',
            'attention' => [
                'pending' => 'Pending/confirmed > :days days',
                'processing' => 'Processing > :days days',
                'unpaid' => 'Unpaid > :days days',
            ],
        ],
        'errors' => [
            'title' => 'Insufficient data',
            'no_brand' => 'No brand associated with user',
        ],
    ],
