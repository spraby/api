...
return [
    ...
    'products_edit' => [
        ...
        'category_options_header' => 'Category and Options',
        'select_all' => 'Select all',
        'deselect_all' => 'Deselect all',
        'generate_variants' => 'Generate Variants',
        'combinations_count' => 'comb.',
        'new_variant_header' => 'New Variant',
        'preview_label' => 'Preview:',
        'duplicate_label' => '— already exists',
        'bulk_pricing_header' => 'Bulk Pricing',
        ...
        'add_btn' => 'Add',
        'delete_btn' => 'Delete',
        'select_value_for' => 'Select value for:',
        'no_variants_message' => 'No variants. Click «Add Variant»',
        'no_options_message' => 'Selected category has no options',
        'select_category_variants' => 'Select a category to add variants',
        'images_header' => 'Images',
        'no_images_short' => 'No images',
        ...
        'summary_price' => 'Price',
        'summary_discounted' => 'Discounted',
        'summary_var_short' => 'var.',
