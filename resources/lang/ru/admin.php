...
return [
    ...
    'brands_edit' => [
        ...
        'domain' => [
            ...
            'description' => 'Хэндл в адресе страницы бренда на витрине: /brands/<домен>. Настраивает только администратор.',
            'label' => 'Домен',
            'save' => 'Сохранить домен',
            'saved' => 'Домен сохранён.',
            'hint_current' => 'Текущий домен бренда — часть адреса /brands/<домен>.',
            'hint_form' => 'Сохраняется вместе с остальными полями бренда.',
            'hint_suggested' => 'Предложен по названию бренда. Станет частью адреса: /brands/<домен>.',
    ...
    'settings_brand_page' => [
        'title' => 'Персональная страница бренда',
        'description' => 'Отдельная страница вашего бренда на витрине. Публикуется после проверки модератором.',
        'statuses' => [
            'none' => 'Не создана',
        ...
        'actions' => [
            'submit' => 'Отправить заявку на публикацию',
            'resubmit' => 'Отправить заявку повторно',
            'open_page' => 'Открыть страницу бренда',
        ],
        'hints' => [
            'submit' => 'Перед отправкой заполните логотип, описание бренда и контакты — модератор смотрит именно их.',
            'pending' => 'Мы сообщим, как только модератор рассмотрит заявку.',
            'no_url' => 'Адрес страницы ещё не назначен. Обратитесь в поддержку.',
        ],
        'published_at' => 'Опубликована',
        'sent_at' => 'Отправлена',
        'reviewed_at' => 'Рассмотрена',
