...
return [
    ...
    'products_edit' => [
        ...
        'view_on_store' => 'Посмотреть в магазине',
        'sections' => [
        ...
        'errors' => [
            ...
            'save_failed' => 'Не удалось сохранить товар',
            'image_attach_failed' => 'Не удалось прикрепить изображения',
            'image_upload_failed' => 'Не удалось загрузить изображения',
            'image_reorder_failed' => 'Не удалось изменить порядок изображений',
            'image_detach_failed' => 'Не удалось удалить изображение',
            'variant_image_failed' => 'Не удалось обновить изображение варианта',
        ],
        'hints' => [
        ...
        'product_title_label' => 'Название продукта',
        'category_options_header' => 'Категория и опции',
        'select_all' => 'Выбрать все',
        'deselect_all' => 'Снять все',
        'generate_variants' => 'Сгенерировать варианты',
        'combinations_count' => 'комб.',
        'new_variant_header' => 'Новый вариант',
        'preview_label' => 'Превью:',
        'duplicate_label' => ' — уже существует',
        'bulk_pricing_header' => 'Массовое ценообразование',
        'sale_price_label' => 'Цена продажи',
        'compare_price_label' => 'Цена до скидки',
        'price_ph' => 'Цена',
        'old_price_ph' => 'Старая',
        'apply_to_all' => 'Применить ко всем',
        'add_btn' => 'Добавить',
        'delete_btn' => 'Удалить',
        'select_value_for' => 'Выберите значение для:',
        'no_variants_message' => 'Нет вариантов. Нажмите «Добавить вариант»',
        'no_options_message' => 'У выбранной категории нет опций',
        'select_category_variants' => 'Выберите категорию, чтобы добавить варианты',
        'images_header' => 'Изображения',
        'no_images_short' => 'Нет изображений',
        ...
        'summary_images' => 'Изображения',
        'summary_variants' => 'Вариантов',
        'summary_price' => 'Цена',
        'summary_discounted' => 'Со скидкой',
        'summary_var_short' => 'вар.',
    ...
    'products_create' => [
        ...
        'toast_error_create' => 'Ошибка при создании',
    ],
    ...
    'brands_edit' => [
        ...
        'shipping_methods_description' => 'Выберите доступные способы доставки для этого бренда',
        'no_shipping_methods' => 'Нет доступных способов доставки',
        'shipping_save' => 'Сохранить',
        'shipping_saving' => 'Сохранение...',
    ],
    ...
    'settings_addresses' => [
        ...
        'messages' => [
            ...
            'delete_error' => 'Не удалось удалить адрес',
        ],
    ...
    'settings_delivery' => [
        'title' => 'Доставка',
        'description' => 'Выберите доступные способы доставки для вашего магазина',
        'no_methods' => 'Нет доступных способов доставки',
        'actions' => [
            'save' => 'Сохранить',
            'saving' => 'Сохранение...',
        ],
        'messages' => [
            'updated' => 'Способы доставки обновлены',
        ],
    ],
