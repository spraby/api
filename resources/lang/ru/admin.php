...
return [
    ...
    'my_categories' => [
        'title' => 'Мои категории',
        'description' => 'Категории, привязанные к вашему бренду, и активные заявки.',
        'sections' => [
            'attached' => 'Привязанные категории',
        ...
        'form' => [
            ...
            'comment_placeholder' => 'Зачем нужны эти категории?',
    ...
    'category_requests' => [
        ...
        'actions' => [
            'view' => 'Открыть',
            'approve' => 'Аппрувить выбранные',
            'reject' => 'Реджектнуть выбранные',
