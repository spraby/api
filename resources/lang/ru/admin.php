...
return [
    ...
    'dashboard' => [
        ...
        'kpi' => [
            ...
            'category_preview_3' => 'Печенье',
            'category_preview_4' => 'Чай',
            'conversion_view_to_atc' => 'Просмотр → В корзину',
            'conversion_view_to_order' => 'Просмотр → Заказ',
            'conversion_view_to_paid' => 'Просмотр → Оплата',
            'conversion_order_to_paid' => 'Заказ → Оплата',
        ],
        'charts' => [
        ...
        'orders_widget' => [
            ...
            'unpaid_count' => 'Заказы: :count',
            'partial_paid_total' => 'Частично',
            'partial_paid_count' => 'Заказы: :count',
            'paid_total' => 'Оплачено',
            'paid_count' => 'Заказы: :count',
